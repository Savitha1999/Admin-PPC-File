...
<li className="p-3 mt-2  text-white"  style={{borderRadius:"5px",  background:"#8BC34A"}}>
  ...
  <li className="p-0 mt-2">
    <NavLink to="/dashboard/offers-raised" style={{color:"rgb(226,41,151)", fontWeight:"bold"}} onClick={toggleSidebar} className={({ isActive }) => (isActive ? "active-link rounded" : "")}>
      <FaFileAlt />
      Offers Raised
    </NavLink>
  </li>
  <li className="p-0 mt-2">
    <NavLink to="/dashboard/photo-request" style={{color:"rgb(226,41,151)", fontWeight:"bold"}} onClick={toggleSidebar} className={({ isActive }) => (isActive ? "active-link rounded" : "")}>
      <FaRegQuestionCircle />
      Photo Request
    </NavLink>
  </li>
